export const services = [
  { 
    ...
    details: "Buzdolabınız yeterince soğutmuyor mu? Veya gürültülü mü çalışıyor? Manisa genelinde tüm markaların buzdolabı tamiri, motor değişimi, gaz dolumu ve kart onarımı işlemlerini yerinde ve 1 yıl garantili olarak yapıyoruz."
  },
  { 
    ...
    details: "Çamaşır makineniz su boşaltmıyor mu? Sıkma sırasında aşırı ses mi çıkarıyor? Uzman ekibimizle tambur değişimi, pompa onarımı ve elektronik kart tamiri gibi her türlü sorunu yerinde çözüyoruz."
  },
  { 
    ...
    details: "Bulaşıklarınız lekeli mi çıkıyor? Makineniz programı bitirmiyor mu? Rezistans değişimi, fıskiye temizliği ve tüm mekanik aksam onarımlarıyla bulaşık makinenizi ilk günkü performansına kavuşturuyoruz."
  },
  { 
    slug: "klima-servisi", 
    name: "Klima Servisi", 
    ...
    details: "Klimanız ısıtmıyor mu veya soğutmuyor mu? Periyodik bakım, gaz dolumu, montaj ve demontaj işlemlerinde Manisa'nın en hızlı teknik ekibiyiz."
  },
  { 
    slug: "kombi-bakimi", 
    name: "Kombi Bakımı", 
    ...
    details: "Kış gelmeden kombi bakımınızı yaptırın, tasarruf edin. Petek temizliği, eşanjör bakımı ve genleşme tankı kontrolleriyle kombiniz her zaman güvende ve verimli olsun."
  },
];
...
export const brands = [
  { 
    slug: "arcelik", 
    name: "Arçelik", 
    details: "Manisa'da Arçelik marka tüm beyaz eşyalarınız için garantili teknik servis hizmeti sunuyoruz. Arçelik buzdolabı, çamaşır makinesi ve bulaşık makinesi arızalarında orijinal yedek parça ve uzman teknisyen kadromuzla yanınızdayız. Arçelik yetkili servis kalitesinde, yerinde ve aynı gün tamir çözümleri sunuyoruz."
  },
  { 
    slug: "beko", 
    name: "Beko", 
    details: "Beko marka beyaz eşyalarınızın ömrünü uzatmak için Manisa genelinde profesyonel servis desteği sağlıyoruz. Beko çamaşır makinesi kart tamiri, buzdolabı motor değişimi ve bulaşık makinesi bakımlarında hızlı ve ekonomik çözümler sunuyoruz. Manisa Beko servisi olarak bir telefonla kapınızdayız."
  },
  { 
    slug: "bosch", 
    name: "Bosch", 
    details: "Alman teknolojisi Bosch cihazlarınız için Manisa'da hassas teknik servis hizmeti veriyoruz. Bosch Serie 4, 6 ve 8 tüm modellerde orijinal parça kullanımıyla cihazınızın performansını koruyoruz. Bosch beyaz eşya arızalarında deneyimli ekibimizle profesyonel müdahale sağlıyoruz."
  },
  { 
    slug: "siemens", 
    name: "Siemens", 
    details: "Siemens ev aletleri için Manisa'da özel teknik servis çözümleri üretiyoruz. iQ300, iQ500 ve iQ700 serisi tüm Siemens buzdolabı ve çamaşır makinelerinde derinlemesine arıza tespiti ve garantili onarım yapıyoruz. Siemens kalitesine yakışır uzman servis hizmeti için bizi arayın."
  },
  { 
    slug: "profilo", 
    name: "Profilo", 
  ...
  { 
    slug: "altus", 
    name: "Altus", 
    details: "Altus beyaz eşya kullanıcıları için Manisa'da kesintisiz teknik servis hizmeti sağlıyoruz. Altus marka buzdolabı, bulaşık makinesi ve fırınlarınızda meydana gelen arızaları uzman kadromuzla hızlıca gideriyoruz. Altus cihazlarınız için güvenilir servis."
  },
  { 
    slug: "samsung", 
    name: "Samsung", 
