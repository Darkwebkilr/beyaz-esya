        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          <header className="text-center lg:text-left order-2 lg:order-1">
            <div className="inline-flex items-center gap-2 bg-white border border-slate-100 rounded-full px-4 py-1.5 mb-8 shadow-sm">
              ...
              <span className="text-xs font-black tracking-[0.2em] uppercase text-black italic">{district.name} Yerel Ekibi</span>
            </div>
            <h1 className="text-4xl md:text-7xl font-black text-foreground italic uppercase tracking-tighter leading-[0.9] mb-8 break-words">
              ...
              <span className="text-black text-lg md:text-2xl tracking-widest block mt-6 font-black uppercase italic">Aynı Gün Onarım | {contact.phone}</span>
            </h1>
        ...
        <section className="bg-white border border-slate-100 p-10 md:p-16 rounded-[40px] shadow-2xl shadow-primary/10 text-center relative overflow-hidden mb-20">
           ...
           <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <a href={`tel:${contact.phoneCall}`} className="flex items-center justify-center gap-3 bg-foreground text-white font-black py-5 px-12 rounded-2xl text-xl hover:bg-primary transition-all shadow-xl shadow-primary/10">
