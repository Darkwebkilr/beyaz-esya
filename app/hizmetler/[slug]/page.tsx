            ...
            <main className="pt-32 pb-24 px-6 max-w-7xl mx-auto">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
                    <header className="text-center lg:text-left order-2 lg:order-1">
                        <div className="flex items-center gap-2 bg-white border border-slate-100 rounded-full px-4 py-1.5 w-fit mb-8 shadow-sm mx-auto lg:mx-0">
                            ...
                            <span className="text-xs font-black tracking-[0.2em] uppercase text-black italic">Profesyonel Teknik Servis</span>
                        </div>
                        <h1 className="text-4xl md:text-7xl font-black text-foreground italic uppercase tracking-tighter leading-[0.9] mb-8 break-words">
                            Manisa <br />
                            <span className="text-primary text-glow text-2xl md:text-5xl tracking-tight uppercase block mt-2">{service.name}</span>
                            <span className="text-black text-lg md:text-2xl tracking-widest block mt-6 font-black italic uppercase">Aynı Gün Servis | {contact.phone}</span>
                        </h1>
                        <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
                            ...
                            <a href={`https://wa.me/${contact.whatsapp}`} className="bg-white border border-slate-100 text-foreground px-8 py-4 rounded-2xl font-black italic uppercase text-sm hover:border-primary/20 transition-all shadow-sm">WhatsApp Destek</a>
                        </div>
                    </header>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
                    <div className="lg:col-span-2 space-y-16">
                        ...
                        <section>
                            <h3 className="text-xl font-black text-foreground italic uppercase mb-8 tracking-tight">Uygulama Örneklerimiz</h3>
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                                {service.gallery?.map((gImg, idx) => (
                                    <div key={idx} className="relative aspect-square rounded-3xl overflow-hidden border border-slate-100 shadow-sm group">
                                        <Image
                                            src={gImg}
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                                    <div className="flex items-start gap-4 p-6 bg-white rounded-3xl border border-slate-50 shadow-sm">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-black/60 text-xs leading-relaxed font-bold">Arıza kaydınızın ardından en geç 2 saat içinde adresinizdeyiz.</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-4 p-6 bg-white rounded-3xl border border-slate-50 shadow-sm">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-black/60 text-xs leading-relaxed font-bold">Tüm onarım ve parça değişimleri resmi servis garantimiz altındadır.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
